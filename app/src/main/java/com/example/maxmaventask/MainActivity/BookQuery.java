...
public class BookQuery {
    ...
    public static List<BookModel> fetchData(String src) {
    ...
    private static List<BookModel> getJSONData(String source) {
        ...
        try {
            ...
            for (int i = 0; i < len; i++) {
                ...
                BookModel book = new BookModel(title, author.toString(), published, publisher, pages, description, image, isbn);
                list.add(book);
            }
